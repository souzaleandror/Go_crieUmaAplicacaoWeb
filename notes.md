...
<td><a href="edit?id={{.Id}}" class="btn btn-info">Editar</a></td>COPIAR CÓDIGO
Em seguida, adicione uma rota no arquivo routes.go, direcionando para o controle de produtos:
http.HandleFunc("/edit", controllers.Edit)COPIAR CÓDIGO
...
Para finalizar, crie uma página chamada edit.html, com um formulário para exibir as informações do produto. No link a seguir, você encontra a página.
Atualizando o produto
Para atualizar o produto, use o verbo POST com a ação update para atualizar:
<form method="POST" action="update">COPIAR CÓDIGO
Em seguida, vamos adicionar uma nova rota para atualizar o produto:
http.HandleFunc("/update", controllers.Update)COPIAR CÓDIGO
...
https://github.com/alura-cursos/web_com_golang/blob/aula_5/templates/edit.html
...
Projeto final
Neste link, você fará o download do projeto final do curso.

Caso queira visualizar todo o código desenvolvido durante o curso, clique neste link.

https://github.com/alura-cursos/web_com_golang/archive/aula_5.zip

https://github.com/alura-cursos/web_com_golang/tree/aula_5
